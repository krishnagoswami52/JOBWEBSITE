...
mongoose.connect(config.MONGO_URI, { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true , useFindAndModify: false }, (error, res) => {
    if (res) {
        console.log('Mongo Atlas Connected successfully to Krishnas DB');
    }
    else {
